...
public class ConjuntoListaLigada {
    ...
    public boolean agregar(char dato) {
        if (perteneceAlConjunto(dato)) {
            System.out.println("Dato ingresado ya pertenece");
            return false;
        }
        if (!perteneceAlUniversal(dato)) {
            System.out.println("Este dato no está dentro del universal");
            return false;
        }
...
public boolean perteneceAlUniversal(char dato) {
